    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='28Z@id2004', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/zaidb/OneDrive/Desktop/Program/Attandance management system/Attendance Management System using Face Recognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='28Z@id2004', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/zaidb/OneDrive/Desktop/Program/Attandance management system/Attendance Management System using Face Recognition/Attendance/'+ fileName
    ...
    def log_in():
        ...
        if username == 'Zayed':
            if password == 'Zayed123':
                ...
                cs = 'C:/Users/zaidb/OneDrive/Desktop/Program/Attandance management system/Attendance Management System using Face Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
